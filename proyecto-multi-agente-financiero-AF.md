...
**Diferenciador v11:** Motor C1-C5 que lee cualquier BP correctamente — sin depender del ERP, del nombre de columna, de la versión del archivo, ni de si el árbol PUC viene expandido o resumido.

---

## 2. MOTOR INFERENCIAL C1-C5

### C5 · Filtro de hojas jerárquicas (nuevo v11)
...
## 5. FLUJO COMPLETO extractAndValidateBP() v11
...
| Archivo | Tamaño |
|---------|--------|
| `multi-agente-fpav.html` — App v11 · C1-C5 | ~161KB |
...
*v11 · Motor C1-C5 · ERP-agnóstico · Sin doble conteo · ADVANCE · Universidad del Rosario · Jun 2026*
